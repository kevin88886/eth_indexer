...
func newApp(logger log.Logger, ss *service.IndexDomainService, rh *handler.IndexHandler, gs *grpc.Server, hs *http.Server) *kratos.App {
	return kratos.New(
		kratos.ID(id),
		kratos.Name(Name),
